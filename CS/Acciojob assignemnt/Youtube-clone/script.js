const API_KEY= "AIzaSyA30DrVeTwfwksaIKqNS2syElyBd42XA2w";
async function mostPopular() {
    try {
      let res = await fetch(`https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=2000&chart=mostPopular&regionCode=IN&key=${API_KEY}`);
      if (!res.ok) {
  ...
  function voiceSearch() {
    ...
    recognition.onresult = function (event) {
      ...
      document.querySelector(".search-bar").value = voiceQuery;
      search();
    };
  }
